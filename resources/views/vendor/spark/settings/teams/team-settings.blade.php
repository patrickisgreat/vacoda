                            ...
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#roles" aria-controls="roles" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-unlock"></i>Team Roles
                                    </a>
                                </li>
                                ...
                                @if (Spark::developer(Auth::user()->email))
                                    <li role="presentation">
                                        <a href="#vacoda-settings" aria-controls="vacoda-settings" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-cog"></i>Vacoda Settings
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (Spark::developer(Auth::user()->email))
                                    <li role="presentation">
                                        <a href="#dev-audit-trail" aria-controls="dev-audit-trail" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-table"></i>DEV Audit Banners
                                        </a>
                                    </li>
                                @endif
            ...
            <div class="col-md-8">
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="roles">
                        <div v-if="team">
                            @include('spark::settings.teams.team-roles')
                        </div>
                    </div>

                    <!-- Vacoda Settings -->
                    <div role="tabpanel" class="tab-pane" id="vacoda-settings">
                        <div v-if="team">
                            @include('spark::settings.teams.vacoda-settings')
                        </div>
                    </div>

                    <!-- DEV Audit Trail -->
                    <div role="tabpanel" class="tab-pane" id="dev-audit-trail">
                        <div v-if="team">
                            @include('spark::settings.teams.dev-audit-list')
                        </div>
                    </div>
