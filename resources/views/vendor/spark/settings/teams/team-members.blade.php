            ...
            <div class="panel-body">
                <table class="table table-borderless m-b-none">
                    <thead>
                        <th></th>
                        <th>Name</th>
                        <th v-if="roles.length > 1">Roles</th>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group" :class="{'has-error': updateTeamMemberForm.errors.has('role')}">
                                <label class="col-md-4 control-label">Team Member Roles</label>
                                ...
                                <div class="col-md-6">
                                    {{--<select class="form-control" v-model="updateTeamMemberForm.role">--}}
                                        ...
                                        {{--</option>--}}
                                    {{--</select>--}}
                                    <ul class="no-bullet all-permissions">
                                        <li v-for="role in roles">
                                            <input type="checkbox" class="@{{role.id}}" value=@{{role.name}} v-model="selectedRoles">
